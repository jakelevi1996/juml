...
def test_max2d():
    ...
    assert repr(pooler) == "Max2d(num_params=55)"
...
def test_max2d_model():
    printer = util.Printer("test_max2d_model", dir_name=OUTPUT_DIR)
    juml.test_utils.set_torch_seed("test_max2d_model")
