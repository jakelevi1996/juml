...
def test_linearset2d():
    printer = util.Printer("test_linearset2d", dir_name=OUTPUT_DIR)
    juml.test_utils.set_torch_seed("test_linearset2d")
    ...
    assert repr(pooler) == "LinearSet2d(num_params=55)"
...
def test_linearset2d_model():
    ...
    juml.test_utils.set_torch_seed("test_linearset2d_model")
