...
OUTPUT_DIR = juml.test_utils.get_output_dir("test_datasets/test_sinmix")

def test_sinmix():
    printer = util.Printer("test_sinmix", dir_name=OUTPUT_DIR)
    juml.test_utils.set_torch_seed("test_sinmix")
    ...
    assert repr(dataset) == "SinMix(n_train=23, n_test=27)"
